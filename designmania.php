...
<ul class="a">
    <li>Only two teams are allowed for one college.</li>
 	<li>In each team only two participants allowed.</li>
 	<li>Tools allowed : Photoshop ,Corel draw.</li>
 	<li>Participants need to submit their designs on google form.</li>
    <li>Google form send to your registered email id.</li>
    <li>Time limit to submit designs will be 1 hour.</li>
